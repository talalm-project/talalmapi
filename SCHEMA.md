...
| `connection_type` | `String(50)` | No | None | Application-level value: `local` |
...
the following application-level value: `local`.
...
| `0005_local_connector_only` | Reserves connector configuration for local model usage only. |
